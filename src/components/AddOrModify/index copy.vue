        ...
        <div class="pilangflexnew" v-if="labeldataForm.dataFormat === 'excel'">
          <div>
            ...
            <span class="pcolorred"
              >（提示：数据项（字段）需逐个新增，且至少明确一个数据项（字段）作为主键，以便开展数据收集）</span
            >
          </div>
          <div class="butflexcz">
        ...
        <el-form :model="tableForm" ref="tableForm" :rules="dataListRules">
          ...
          >
            ...
            <el-table-column prop="name" label="中文名称" width="180">
              <template slot-scope="{ row, $index }">
                <el-form-item :prop="'dataList.' + $index + '.name'" :rules="dataListRules.name">
                  <el-input v-model="row.name" size="small" placeholder="XXX"></el-input>
                </el-form-item>
              </template>
            </el-table-column>
            <el-table-column prop="enName" label="英文名称" width="180">
              <template slot-scope="{ row, $index }">
                <el-form-item :prop="'dataList.' + $index + '.enName'" :rules="dataListRules.enName">
                  <el-input v-model="row.enName" size="small" placeholder="XXX"></el-input>
                </el-form-item>
              </template>
            </el-table-column>
            <el-table-column prop="dataType" label="数据类型" width="140">
              <template slot-scope="{ row, $index }">
                <el-form-item :prop="'dataList.' + $index + '.dataType'" :rules="dataListRules.dataType">
                  <!-- <el-form-item> -->
                  <el-select v-model="row.dataType" size="small" placeholder="请选择">
                    <el-option
                      :label="field.text"
                      :value="field.value"
            ...
            <el-table-column prop="dataLength" label="数据长度" width="140">
              <template slot-scope="{ row, $index }">
                <el-form-item :prop="'dataList.' + $index + '.dataLength'" :rules="dataListRules.dataLength">
                  <el-input v-model="row.dataLength" size="small" placeholder="XXX"></el-input>
                </el-form-item>
              </template>
            </el-table-column>
            <el-table-column prop="dataDictionary" label="数据字典项" width="140">
              <template slot-scope="{ row }">
                <el-form-item>
                  <el-input v-model="row.dataDictionary" size="small" placeholder="XXX"></el-input>
                </el-form-item>
              </template>
            </el-table-column>
            ...
            <el-table-column prop="shareProperty" label="共享属性" width="140">
              <template slot-scope="{ row, $index }">
                <el-form-item :prop="'dataList.' + $index + '.shareProperty'" :rules="dataListRules.shareProperty">
            ...
            <el-table-column prop="sharingCondition" label="共享条件" width="140">
              <template slot-scope="{ row, $index }">
                <el-form-item
                  ...
                  :rules="row.shareProperty === '1' ? dataListRules.sharingCondition : [{ required: false }]"
                >
                  <el-input
                    v-model="row.sharingCondition"
                    :disabled="row.shareProperty !== '1'"
                    size="small"
                    placeholder="XXX"
                  ></el-input>
                </el-form-item>
            ...
            <el-table-column prop="openAttribute" label="开放属性" width="140">
              <template slot-scope="{ row, $index }">
                <el-form-item :prop="'dataList.' + $index + '.openAttribute'" :rules="dataListRules.openAttribute">
            ...
            <el-table-column prop="nullValue" label="是否可为空" width="140">
              <template slot-scope="{ row, $index }">
                <el-form-item :prop="'dataList.' + $index + '.nullValue'" :rules="dataListRules.nullValue">
                  <el-select v-model="row.nullValue" size="small" placeholder="请选择">
                    <el-option
            ...
            <el-table-column prop="dataObject" label="数据对象" width="140">
              <template slot-scope="{ row, $index }">
                <el-form-item :prop="'dataList.' + $index + '.dataObject'" :rules="dataListRules.dataObject">
            ...
            <el-table-column prop="dataLevel" label="数据级别" width="140">
              <template slot-scope="{ row, $index }">
                <el-form-item :prop="'dataList.' + $index + '.dataLevel'" :rules="dataListRules.dataLevel">
            ...
            <el-table-column prop="fieldDescription" label="字段描述" width="180">
              <template slot-scope="{ row, $index }">
                <el-form-item>
                  <el-input v-model="row.fieldDescription" size="small" placeholder="XXX"></el-input>
                </el-form-item>
              </template>
            </el-table-column>
      ...
      <div v-if="labeldataForm.dataFormat === '接口'">
        ...
        <el-form :model="requestForm" ref="requestForm" :rules="requestRules">
          ...
          >
            ...
            <el-table-column prop="parameterName" label="参数名称" width="230">
              <template slot-scope="{ row, $index }">
                <el-form-item :prop="'parameterList.' + $index + '.parameterName'" :rules="requestRules.parameterName">
            ...
            <el-table-column prop="required" label="是否必填" width="140">
              <template slot-scope="{ row, $index }">
                <el-form-item :prop="'parameterList.' + $index + '.required'" :rules="requestRules.required">
            ...
            <el-table-column prop="type" label="类型" width="180">
              <template slot-scope="{ row, $index }">
                <el-form-item :prop="'parameterList.' + $index + '.type'" :rules="requestRules.type">
            ...
            <el-table-column prop="defaultValue" label="默认值" width="180">
              <template slot-scope="{ row, $index }">
                <el-form-item :prop="'parameterList.' + $index + '.defaultValue'" :rules="requestRules.defaultValue">
                  <el-input v-model="row.defaultValue" size="small" placeholder="XXX"></el-input>
                </el-form-item>
              </template>
            </el-table-column>
        ...
        <el-form :model="returnForm" ref="returnForm" :rules="returnFormRules">
          ...
          >
            ...
            <el-table-column prop="required" label="是否必填" width="140">
              <template slot-scope="{ row, $index }">
                <el-form-item :prop="'parameteReturnList.' + $index + '.required'" :rules="returnFormRules.required">
                  <el-select v-model="row.required" size="small" placeholder="请选择">
                    <el-option label="是" value="0"></el-option>
                    <el-option label="否" value="1"></el-option>
                  </el-select>
            ...
            <el-table-column prop="type" label="类型" width="180">
              <template slot-scope="{ row, $index }">
                <el-form-item :prop="'parameteReturnList.' + $index + '.type'" :rules="returnFormRules.type">
                  <el-select v-model="row.type" size="small" placeholder="请选择">
                    <el-option
                      :label="paraitem.text"
                      :value="paraitem.text"
    ...
    <el-card class="cardpadmargtop">
      <el-row>
        <el-col :span="6" :offset="20">
          <div class="flootdivmag">
            <el-button size="small" type="primary" @click="isShowSave = true">保存</el-button>
      ...
      <el-dialog title="Excel导入" class="dialoghei" :visible.sync="isAskExport" width="30%">
        ...
        <div class="buttonflex">
          <el-button size="small" class="buttonmargin" @click="isAskExport = false">取 消</el-button>
          <el-button
            type="primary"
            size="small"
            class="buttonrigth"
...
export default {
  ...
  data() {
    let blurEn = (rule, value, callback) => {
      let engl = /^[A-Za-z0-9 _]*[A-Za-z]+[A-Za-z0-9 ]*$/
      if (!engl.test(value)) {
    ...
    return {
      ...
      bmCatalogDataSourceRules: {
        databaseName: [{ required: true, message: '请选择数据库名', trigger: 'change' }],
      ...
      dataListRules: {
        ...
        dataLength: [{ required: true, message: '请输入数据长度', trigger: 'blur' }],
  ...
  methods: {
    ...
    getAddData(val) {
      ...
      this.$refs['related'].resetFields()
      this.$refs['Library'].resetFields()
      this.$refs['tableForm'].resetFields()
      this.$refs['bmCatalogDataSource'].resetFields()
      // this.$refs['bmCatalogDataSource'].clearValidate()
    },
    // 复制
    getCopyData(row) {
      this.formLabelAlign.isCopy = '1'
      // xinzeng
      let arrayid = row
    ...
    addSubmit() {
          ...
          this.$refs['tableForm'].validate(valid => {
            if (valid) {
              ...
              if (primary == true) {
                ...
                Message.error('请至少明确一个数据项（字段）作为主键，以便开展数据收集')
              }
            } else {
              this.isExamineDialogVisible = false
              this.loadSubmit = false
              Message.error('请填写必选项')
            }
          })
        } else {
          resolve()
        ...
        if (this.labeldataForm.dataFormat === '接口') {
          this.$refs['returnForm'].validate(valid => {
            if (valid) {
              ...
              this.isExamineDialogVisible = false
              this.loadSubmit = false
              Message.error('请填写必选项：返回参数表格的参数位置选项')
            }
          })
        } else {
          resolve()
      ...
      Promise.all([p1, p2, p3, p4, p5, p6, p7, p8, p9, p10]).then(() => {
        ...
        this.formLabelAlign.allowNull = '1'
        let dataformLabel = this.formLabelAlign
        console.log(this.dataformLabel)
        if (this.modifyId != '' || this.modifyIdDraft != '') {
          let catalogid = { id: this.addId }
          postUpdate(dataformLabel).then(res => {
            if (res.success) {
    ...
    importExcelList(val) {
      if (
        ...
        this.tableForm.dataList[0].primaryKey == '' &&
