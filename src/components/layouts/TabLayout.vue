<template>
  <global-layout @dynamicRouterShow="dynamicRouterShow">
    ...
    <!-- <div style="margin: 12px 12px 0;min-width: 1400px;">
      内容
    <div style="margin: 12px 12px 0; background-color: #f2f6f9;">
...
<script>
  ...
  const indexKey = '/pageHome/PageHome'
