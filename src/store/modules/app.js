...
const app = {
  ...
  mutations: {
    ...
    SET_ORG_DATA (state, multipageFlag) {
      Vue.ls.set(ORG_DATA, multipageFlag)
      state.orgData = multipageFlag
    },
  ...
  actions: {
    ...
    ToggleOrgData({ commit }, multipageFlag) {
      commit('SET_ORG_DATA', multipageFlag)
    }
