  ...
  <div>
    <div v-show="!isNewData && !isshowMessage">
      <el-card class="box-card">
        <el-form :inline="true" ref="learning" size="small" :model="learning" class="farderfromflex">
          <div class="divffromflex">
            <el-form-item label="公告标题：" prop="informationName">
      ...
      <el-card class="cardmargtop">
        <el-button type="primary" size="small" @click="addRelease" v-has="'isAnnouncementNotice:issueData'"
          >发布公告</el-button
        >
        <el-button
          type="primary"
          ...
          :disabled="deleteAll"
          v-has="'isAnnouncementNotice:allDelete'"
          >批量删除</el-button
        >
        <el-table
          :header-cell-style="{
        ...
        >
          ...
          <el-table-column label="操作">
            <template slot-scope="{ row, $index }">
              <el-button type="text" slot="reference" @click="deleteWorld(row)" v-has="'isAnnouncementNotice:delete'"
                >删除</el-button
              >
              <el-button type="text" slot="reference" @click="modifyNewData(row)" v-has="'isAnnouncementNotice:change'"
                >修改</el-button
              >
            </template>
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    addRelease() {
      ...
      this.$refs.dataFrom.form.informationType = '3';
      this.isNewData = true;
    },
  },
  computed: {
