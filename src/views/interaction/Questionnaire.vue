    ...
    <div v-show="!isshowNewAnnoun && !isshowContent">
      <el-card>
        <el-form :inline="true" :model="cement" size="small" ref="cement" class="demo-form-inline faderfrom">
          <div class="divffromflex">
            <el-form-item label="问卷标题" prop="title" class="topfromitem">
      ...
      <el-card class="cardmargtop">
        ...
        >
          ...
          <el-table-column prop="title" label="问卷标题" min-width="20%"> </el-table-column>
          <el-table-column prop="createdTime" label="发布时间" min-width="12%"> </el-table-column>
          <el-table-column prop="status" label="状态" min-width="12%"> </el-table-column>
          <el-table-column prop="joinNumber" label="参与人数" min-width="12%"> </el-table-column>
...
import { questionnaireList, queryById, postedit,deleteQuestion } from '@/api/api'
