...
//   return request({
//     url: '/flowable/definition/readXmlByDataId/',
//     method: 'post',
//     data: dataId
//   })
// }
export function readXmlByDataId(processCode) {
  return request({
    url: '/flowable/definition/readXmlByDataId/',
    method: 'post',
    data: processCode
...
// export function getFlowViewerByDataId(dataId) {
//   return request({
//     url: '/flowable/task/flowViewerByDataId',
//     method: 'post',
//     data: dataId
//   })
// }
export function getFlowViewerByDataId(processCode) {
  return request({
    url: '/flowable/task/flowViewerByDataId',
    method: 'post',
    data: processCode
