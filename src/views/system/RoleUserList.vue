    ...
    <a-col :md="leftColMd" :sm="24" style="margin-bottom: 20px">
      <a-card :bordered="false">
        ...
        <div class="table-operator" style="margin: 5px 0 10px 2px">
          <a-button @click="handleAdd" type="primary" icon="plus" v-has="'isRoleUser:addRole'">新建角色</a-button>
        ...
        <div style="margin-top: 15px">
          ...
          >
            <span slot="action" slot-scope="text, record">
              <a @click="handleOpen(record)" v-has="'isRoleUser:userDetails'">用户</a>
              <a-divider type="vertical" />
              <a-dropdown>
                <a class="ant-dropdown-link"> 更多 <a-icon type="down" /> </a>
                <a-menu slot="overlay">
                  <a-menu-item>
                    <a @click="handlePerssion(record.id)">功能权限配置</a>
                  </a-menu-item>
                  <!-- <a-menu-item>
                  <a @click="dataPerssion(record)">数据权限配置</a>
                </a-menu-item> -->
                  <a-menu-item>
                    <a @click="handleEdit(record)" v-has="'isRoleUser:edit'"> 编辑</a>
                  </a-menu-item>
                  <a-menu-item>
                    <a-popconfirm title="确定删除吗?" @confirm="() => handleDelete1(record.id)" v-has="'isRoleUser:delete'">
                      <a>删除</a>
                    </a-popconfirm>
                  </a-menu-item>
                </a-menu>
        ...
        <data-role-modal ref="modalDataRole"></data-role-modal>
...
import DataRoleModal from './modules/DataRoleModal'
...
export default {
  ...
  methods: {
    ...
    onClearSelected() {},
    dataPerssion(record) {
      this.$refs.modalDataRole.show(record.id)
    },
    getQueryParams2() {
      //获取查询条件
      let sqp = {}
