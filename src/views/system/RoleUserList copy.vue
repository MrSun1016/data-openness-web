<template>
  <a-row :gutter="10">
    <a-col :md="8" :sm="24">
      <depart-components @keySelect='keySelect'></depart-components>
    </a-col>
    <a-col :md="16" :sm="24" style="margin-bottom: 20px">
      <a-card :bordered="false">
        ...
        <div class="table-operator" style="margin: 5px 0 10px 2px">
          <a-button v-if="queryParam.deptId" @click="handleAdd" type="primary" icon="plus">新建角色</a-button>
          ...
          >
            <span slot="action" slot-scope="text, record">
              ...
              <a-dropdown>
                ...
                <a-menu slot="overlay">
                  <a-menu-item>
                    <a @click="handlePerssion(record.roleId)">功能权限</a>
                  </a-menu-item>
                  <a-menu-item>
        ...
        <role-modal :deptId='queryParam.deptId' ref="modalForm" @ok="modalFormOk"></role-modal>
      </a-card>
    </a-col>
    <a-drawer
      :footer="null"
        ...
        <div>
          ...
          <span slot="status" slot-scope="text">
            ...
            <span slot="action" slot-scope="text, record">
              ...
              <!-- <a @click="handleDelete2(record.id)">删除</a> -->
            </span>
...
import departComponents from './departComponents'
export default {
  name: 'RoleUserList',
  ...
  methods: {
    ...
    handleDelete1: function (record) {
      ...
      deleteAction('/sys/sysDepartRole/delete',{id:record.id})
      this.dataSource2 = []
      this.currentRoleId = ''
    },
    ...
    handleOpen (record) {
      this.rightcolval = 1
      this.selectedRowKeys1 = [record.roleId]
