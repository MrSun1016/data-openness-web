    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="行政区划" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-select placeholder="请选择" v-decorator="['govArea', {}]" show-search option-filter-prop="children">
            <a-select-option v-for="item in division" :key="item.value">{{ item.text }}</a-select-option>
          </a-select>
        </a-form-item>
...
import { queryIdTree, getGovAreaList } from '@/api/api'
...
export default {
  ...
  data() {
    return {
      ...
      validatorRules: {
        // govArea:{rules: [{ required: true, message: '请选择行政区划' }]},
