    ...
    <div id="homemine" v-show="!isshowHaredetails">
        ...
        <div style="min-height: 242px; background: #fff; position: relative">
          ...
          <div class="info" v-for="datas in myCatalogData" :key="datas.id">
            ...
            <div class="catalog-item" style="color: #1890ff; cursor: pointer;" @click="handleCatalogDet(datas)">
              <el-tooltip :content=datas.catalogName placement="top">
                <span>{{ datas.catalogName || '-' }}</span>
              </el-tooltip>
            </div>
            ...
            <div class="catalog-item">
              <el-tooltip :content=datas.sourceSystem placement="top">
                <span>{{ datas.sourceSystem || '-' }}</span>
              </el-tooltip>
            </div>
            <div class="catalog-item">
              <el-tooltip :content=datas.sourceUnit placement="top">
                <span>{{ datas.sourceUnit || '-' }}</span>
              </el-tooltip>
            </div>
            <div class="catalog-item">
              <el-tooltip :content=datas.releaseTime placement="top">
                <span>{{ datas.releaseTime || '-' }}</span>
              </el-tooltip>
            </div>
          </div>
        </div>
      ...
      <div class="help-text">
        ...
        <div v-if="helpDocData.length > 0" style="min-height: 242px; background: #fff; cursor: pointer">
          ...
          >
            <div class="over-text" style="color: #1890ff;width: 70%;">
              <span  v-show="helps.isTop === 1" style="color: red">【置顶】</span
              >
              <el-tooltip :content=helps.uploadFileName placement="top">
                <span>{{ helps.uploadFileName || '-' }}</span>
              </el-tooltip>
            </div>
