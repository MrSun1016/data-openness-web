<template>
  <div id="myShareUseing">
    ...
    <div :class="isshowHaredetails ? 'trueCss' : 'falseCss'" class="box-card" style="margin-top: 24px">
      <InformationUseing ref="exatablesLoading" @handleShow="handleShow" :informationData="informationData" />
    ...
    return {
      ...
      tabsOptions: {
        inquireData: {
          ...
          pageNum: 1, //查询第一页
          pageSize: 10,
          queryType: 3, //查询类型 1:我的数据 2:审批中 3:正在使用 4:已释放列表 5:共享驳回记录
          rejectDate: '',
          rowStart: 0,
          shareOffDate: '',
          shareOffStatus: '',
